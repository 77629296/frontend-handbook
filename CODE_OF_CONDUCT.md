...
访问 https://lisipeng.com/frontend-handbook/

**注意：文中涉及的配置文件和代码链接在网页中将无法访问，请下载GitHub源码后，在Markdown编辑器中打开，点击链接将跳转到你的本地目录，推荐使用[typora](https://typora.io)，或者直接登录[github](https://github.com/77629296/frontend-handbook) 查看。**
...
访问 [gitbook](https://www.gitbook.com/book/77629296/frontend-handbook/details) 可以看到下载地址，可以下载根据最新文档生成的 **PDF/ePub/Mobi** 格式文档（文档的注脚中注明了更新时间），同时也可以直接在 gitbook 中阅读，不过 gitbook 不太稳定打开速度较慢，建议大家直接在 https://lisipeng.com/frontend-handbook/ 浏览。
...
在该项目目录下执行以下命令生成`frontend-handbook.pdf`文档。

```bash
gitbook pdf . ./frontend-handbook.pdf
```
